    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          ...
          <!--放大镜效果-->
          <Zoom :skuImageList="sukImageList" :imge="$route.query.imge"/>
          <!-- 小图列表 -->
          <ImageList :skuImageList="sukImageList" :imge="$route.query.imge"/>
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,i) in spuSaleAttrList" :key="i">
                <dt class="title">{{ spuSaleAttr.saleAttrName }}</dt>
                <dd @click="changeActive(spu,spuSaleAttr.spuSaleAttrValueList)" changepirce="0" :class="{active:spu.isChecked==1}" v-for="(spu,i) in spuSaleAttr.spuSaleAttrValueList" :key="i">{{spu.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
    ...
    methods:{
      ...
      async addShopCar(){
        ...
        try {
          ...
          //路由跳转,传参
          //skuNum简单数据，通过query传参
          // 复杂数据skuInofo通过浏览器绘画存储传参
