<template>
  <div class="cart">
      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="cart in cartInfoList" :key="cart.id">
          ...
          <li class="cart-list-con5">
            ...
            <input autocomplete="off" type="text" :value="cart.skuNum" minnum="1" class="itxt" @change="handler('ipt',$event.target.value*1,cart)">
    ...
    <div class="cart-tool">
      ...
      <div class="option">
        <a @click="deleteAllCheckedCard" href="#none">删除选中的商品</a>
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      //修改产品个数,节流
      handler:throttle(async function(type,disNum,cart){//三个元素，变化量，产品id
        switch(type){
          //加号
          case "add":
            break
